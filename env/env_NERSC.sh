...
umask 0027 # restrict global access 
def_mod=1750 # sets default file permissions 

##############################
##### CUSTOM ENVIRONMENT ##### 
##############################

default_cuts=medium # default box cuts to be applied, not currently used

# set this variable to the top level of your analysis 
export workDir=$scratchDir/Crab # the paths worked with within the processing scripts 
...
######################
batch_cmd=sbatch 
[ "$use_docker" ] || use_docker=true # by default launch jobs in docker / shifter image 
